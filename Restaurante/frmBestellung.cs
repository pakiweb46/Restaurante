...
namespace Restaurante
{
    ...
    public partial class frmBestellung : Form
    {
        ...
        private MySqlDataReader rdr, rdr1;
        private Zutaten obj;
        ...
        private RestauranteData rData; // Haltet Data
        ...
        public void PerformListFill()
        {
            ...
            MySqlDataReader rSpeiskeKarte = rData.getAllCardData();
            ...
            rData.openReadConnection();
            MySqlDataReader rZutaten = rData.getAllZutatenData();
            if (rZutaten.HasRows)
            {
                while (rZutaten.Read())
                {
